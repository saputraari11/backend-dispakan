...
export class StoreController {
  ...
  async uploadFile(@Body() data: CreateStoreDto,@UploadedFile('file') file:Express.Multer.File) {
    data.file = file
  ...
  async updateFile(@Param('id') id:string,@Body() data: CreateStoreDto,@UploadedFile('file') file:Express.Multer.File) {
    data.file = file
